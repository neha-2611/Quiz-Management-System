...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="dkk.jpeg" alt="Goswami Neha" style="width:100%">
      <div class="container">
        <h2>Goswami Neha</h2>
        <p class="title">Developer</p>
        <p>I am frontend and backend developer.</p>
        <p>nehagoswami2611@gmail.com</p>
        <p><button class="button"><a href="tel:+8469819937">contact</a></button></button></p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="dk.jpg" alt="Daksh Raval" style="width:100%">
      <div class="container">
        <h2>Daksh Raval </h2>
        <p class="title">Developer</p>
        <p>I am frontend and backend developer.</p>
        <p>dakshraval2002@gmail.com</p>
        <p><button class="button"><a href="tel:+919054814055">contact</a></button></p>
      </div>
    </div>
  </div>
